...
module.exports = {
  ...
  vnp_ReturnUrl: process.env.VNP_RETURNURL || process.env.VNP_RETURN_URL || 'http://localhost:6000/api/payment/vnpay/return', // URL return sau khi thanh toán
  ...
  vnp_IpnUrl: process.env.VNP_IPNURL || process.env.VNP_IPN_URL || 'http://localhost:6000/api/payment/vnpay/ipn', // URL nhận IPN
};
